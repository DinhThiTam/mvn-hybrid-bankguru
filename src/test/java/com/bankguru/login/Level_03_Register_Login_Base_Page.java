...
public class Level_03_Register_Login_Base_Page {
	WebDriver driver;
	...
	//Che giấu sự khởi tạo của đối tượng (đi theo  hướng của đối tượng > bảo mật...)
	...
	public void Login_01_Register_To_System() {
		...
		basePage.senkeyToElement(driver, "//input[@name='emailid']", getRandomEmail());
