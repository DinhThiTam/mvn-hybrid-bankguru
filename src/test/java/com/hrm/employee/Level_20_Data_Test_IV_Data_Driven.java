...
public class Level_20_Data_Test_IV_Data_Driven extends BaseTest{
	...
	public void Employee_01_Add_New_Employee() {
		...
		addEmployeePage.enterToTextboxByID(driver, employeeData.getFirtname(), "firstName");
		...
		verifyTrue(employeePage.isJQueryAjaxLoadedSuccess(driver));
		employeePage.enterToTextboxByID(driver, employeeData.getFullname(), "empsearch_employee_name_empName");
	...
	public void Employee_03_Personal_Details() {
		...
		myInfoPage.enterToTextboxByID(driver, employeeData.getEditFirstName(), "personal_txtEmpFirstName");
