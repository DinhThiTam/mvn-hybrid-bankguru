...
public class LoginPageObject extends BasePage{
	...
	public String getEmptyPasswordErrorMessage() {
		waitForElementVisible(driver, LoginPageUI.EMPTY_PASSWORD_MESSAGE);
		return getElementText(driver, LoginPageUI.EMPTY_PASSWORD_MESSAGE);
	}

	public String getInvalidEmailErrorMessage() {
		waitForElementVisible(driver, LoginPageUI.INVALID_EMAIL_MESSAGE);
	...
	public String getInvalidPasswordErrorMessage() {
		...
		return getElementText(driver, LoginPageUI.INVALID_PASSWORD_MESSAGE);
	}

	public String getInvalidEmailOrPasswordErrorMessage() {
		waitForElementVisible(driver, LoginPageUI.INVALID_EMAIL_AND_PASSWORD_MESSAGE);
		return getElementText(driver, LoginPageUI.INVALID_EMAIL_AND_PASSWORD_MESSAGE);
	}
